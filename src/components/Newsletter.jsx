      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center max-w-lg mx-auto">
            {/* Discord Button - Only show if configured in admin */}
            {settings.discord && (
              <motion.a
            ...
            {/* WhatsApp Button - Only show if configured in admin */}
            {settings.whatsapp && (
              <motion.a
            ...
            {!settings.discord && !settings.whatsapp && (
              <p className="text-white/40 text-sm italic">Social links coming soon...</p>
            )}
          </div>
